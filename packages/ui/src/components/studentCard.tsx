...
const StudentCard = ({ student, index }: StudentCardProps) => {
  ...
  return (
    <div className="bg-white dark:bg-zinc-800 rounded-xl p-3 sm:p-4 border border-gray-200 dark:border-zinc-700 hover:border-indigo-300 dark:hover:border-indigo-600 transition-all duration-200 hover:shadow-lg">
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <div className="relative flex shrink-0">
          ...
          />
          <div className="absolute -bottom-1 -right-1 bg-indigo-600 dark:bg-indigo-500 text-white text-xs font-semibold rounded-full w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center border-2 border-white dark:border-zinc-800">
            {index + 1}
          </div>
        </div>
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
            {formatStudyTime(student.totalHours)} studied
          </p>
        </div>
        ...
        <div className="flex items-center gap-1 sm:gap-2 shrink-0">
          ...
          {/* Follow Button */}
          <button
            className="p-1.5 sm:p-2 rounded-lg bg-indigo-600 hover:bg-indigo-700 transition-colors group"
            aria-label="Follow"
          >
            <svg
